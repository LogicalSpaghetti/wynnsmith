...
export const categorizedBaseStats = [
    ["baseHealth"],
    ["baseEarthDefence", "baseThunderDefence", "baseFireDefence", "baseWaterDefence", "baseAirDefence"],
...
export const categorizedRegularIds = [
    // the barely a regular stat
    [
        "rawAttackSpeed",
    ],
    [
