...
# Feature:
Use the new JSON format generated by Kotlin
https://thegraycuber.github.io/ looks so absurdly sexy
Map ids and such to short-hands to reduce `item.json`'s file size
# Bug-fix:
