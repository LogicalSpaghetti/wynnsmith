...
var require_dist = __commonJS({
  "node_modules/expect-type/dist/index.js"(exports) {
    ...
    exports.expectTypeOf = expectTypeOf3;
  }
});
...
var serialize$3 = (node, config2, indentation, depth, refs, printer2) => {
  ...
  return printElement(type3, printProps(nodeIsFragment(node) ? [] : Array.from(node.attributes, (attr) => attr.name).sort(), nodeIsFragment(node) ? {} : [...node.attributes].reduce((props, attribute) => {
    props[attribute.name] = attribute.value;
    return props;
  }, {}), config2, indentation + config2.indent, depth, refs, printer2), (nodeIsFragment(node) || !node.shadowRoot ? "" : printShadowRoot(Array.prototype.slice.call(node.shadowRoot.children), config2, indentation + config2.indent, depth, refs, printer2)) + printChildren(Array.prototype.slice.call(node.childNodes || node.children), config2, indentation + config2.indent, depth, refs, printer2), config2, indentation);
};
var plugin$3 = {
...
function spyOn(object2, key, accessor) {
  assert(object2 != null, "The vi.spyOn() function could not find an object to spy upon. The first argument must be defined.");
  assert(typeof object2 === "object" || typeof object2 === "function", "Vitest cannot spy on a primitive value.");
  const [originalDescriptorObject, originalDescriptor] = getDescriptor(object2, key) || [];
  assert(originalDescriptor || key in object2, `The property "${String(key)}" is not defined on the ${typeof object2}.`);
...
function createMock({ state, config: config2, name: mockName, prototypeState, prototypeConfig, keepMembersImplementation, mockImplementation, prototypeMembers = [] }) {
  ...
  const namedObject = { [name]: (function(...args) {
    ...
    const implementation = config2.onceMockImplementations.shift() || config2.mockImplementation || (prototypeConfig === null || prototypeConfig === void 0 ? void 0 : prototypeConfig.onceMockImplementations.shift()) || (prototypeConfig === null || prototypeConfig === void 0 ? void 0 : prototypeConfig.mockImplementation) || original || function() {
    };
    let returnValue;
    let thrownValue;
    let didThrow = false;
...
function expectTypes(obj, types) {
  ...
  types.sort();
  let str = types.map(function(t, index3) {
    let art = ~["a", "e", "i", "o", "u"].indexOf(t.charAt(0)) ? "an" : "a";
    let or = types.length > 1 && index3 === types.length - 1 ? "or " : "";
    return or + art + " " + t;
  }).join(", ");
...
var getArrayName2 = __name((array2) => {
  if (typeof Buffer === "function" && array2 instanceof Buffer) {
    return "Buffer";
  }
  if (array2[Symbol.toStringTag]) {
...
var inspectCustom2 = __name((value, options, type3, inspectFn) => {
...
function iterableEqual(leftHandOperand, rightHandOperand, options) {
  ...
  var index3 = -1;
  while (++index3 < length) {
    if (deepEqual(leftHandOperand[index3], rightHandOperand[index3], options) === false) {
      return false;
    }
  }
  return true;
...
function closeTo(expected, delta, msg) {
  ...
  const abs = __name((x) => x < 0 ? -x : x, "abs");
...
function getObjectKeys(object2) {
  return [...Object.keys(object2), ...Object.getOwnPropertySymbols(object2).filter((s) => {
    var _Object$getOwnPropert;
    return (_Object$getOwnPropert = Object.getOwnPropertyDescriptor(object2, s)) === null || _Object$getOwnPropert === void 0 ? void 0 : _Object$getOwnPropert.enumerable;
  })];
}
...
function recordAsyncExpect(_test2, promise, assertion, error) {
  ...
  if (test5 && promise instanceof Promise) {
    promise = promise.finally(() => {
      ...
      const index3 = test5.promises.indexOf(promise);
      if (index3 !== -1) {
        test5.promises.splice(index3, 1);
      }
    });
    if (!test5.promises) {
      test5.promises = [];
...
(${stripped} matching ${stripped === 1 ? "property" : "properties"} omitted from actual)`;
  ...
  def("toContainEqual", function(expected) {
    const obj = utils.flag(this, "object");
    const index3 = Array.from(obj).findIndex((item) => {
      return equals(item, expected, customTesters);
    });
    this.assert(index3 !== -1, "expected #{this} to deep equally contain #{exp}", "expected #{this} to not deep equally contain #{exp}", expected);
  });
  ...
  [{
    ...
    condition: (spy, index3, value) => {
      const result = spy.mock.settledResults[index3 - 1];
    ...
    condition: (spy, index3, value) => {
      const result = spy.mock.results[index3 - 1];
...
function delay(timeout, scheduler = setTimeout) {
  return new Promise((resolve4) => scheduler(resolve4, timeout));
}
...
var resolve = function(...arguments_) {
  ...
  for (let index3 = arguments_.length - 1; index3 >= -1 && !resolvedAbsolute; index3--) {
    const path = index3 >= 0 ? arguments_[index3] : cwd();
  ...
  for (let index3 = 0; index3 <= path.length; ++index3) {
    ...
    if (char === "/") {
      if (lastSlash === index3 - 1 || dots === 1) ;
        ...
        if (res.length > 0) {
          res += `/${path.slice(lastSlash + 1, index3)}`;
        } else {
          res = path.slice(lastSlash + 1, index3);
        }
...
var _lazyMatch = () => {
  var __lib__ = (() => {
    ...
    q(w, { default: () => re });
    var A = (r) => Array.isArray(r), d2 = (r) => typeof r == "function", Q = (r) => r.length === 0, W = (r) => typeof r == "number", K = (r) => typeof r == "object" && r !== null, X = (r) => r instanceof RegExp, b = (r) => typeof r == "string", h2 = (r) => r === void 0, Y = (r) => {
      ...
      return (a) => {
        ...
        const u = a.index;
        if (u > t) {
          if (!h2(e) && !a.options.silent) {
            const s = a.input.slice(t, u), c = d2(e) ? e(s, o, String(t)) : e;
            h2(c) || a.output.push(c);
          }
      ...
      return g2((o) => {
        ...
        if (u) {
          if (!h2(e) && !o.options.silent) {
            const s = d2(e) ? e(...u, o.input, String(o.index)) : e;
            h2(s) || o.output.push(s);
          }
    ...
    }, tr = (r, e) => C2(r, 0, 1), f2 = (r, e) => C2(r, 0, 1 / 0), x = (r, e) => {
      const n = r.map(v);
      return g2(_(M((a) => {
    ...
    }, sr = i(/^\*\*\/\*$/, ".*"), cr = i(/^\*\*\/(\*)?([ a-zA-Z0-9._-]+)$/, (r, e, n) => `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}`), lr = i(/^\*\*\/(\*)?([ a-zA-Z0-9._-]*)\{([ a-zA-Z0-9._-]+(?:,[ a-zA-Z0-9._-]+)*)\}$/, (r, e, n, a) => `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}(?:${a.replaceAll(",", "|").replaceAll(".", "\\.")})`), y = i(/\\./, p), pr = i(/[$.*+?^(){}[\]\|]/, (r) => `\\${r}`), vr = i(/./, p), hr = i(/^(?:!!)*!(.*)$/, (r, e) => `(?!^${L(e)}$).*?`), dr = i(/^(!!)+/, ""), fr = l([hr, dr]), xr = i(/\/(\*\*\/)+/, "(?:/.+/|/)"), gr = i(/^(\*\*\/)+/, "(?:^|.*/)"), mr = i(/\/(\*\*)$/, "(?:/.*|$)"), _r = i(/\*\*/, ".*"), j = l([xr, gr, mr, _r]), Sr = i(/\*\/(?!\*\*\/)/, "[^/]*/"), yr = i(/\*/, "[^/]*"), N = l([Sr, yr]), k = i("?", "[^/]"), $r = i("[", p), wr = i("]", p), Ar = i(/[!^]/, "^/"), br = i(/[a-z]-[a-z]|[0-9]-[0-9]/i, p), Cr = i(/[$.*+?^(){}[\|]/, (r) => `\\${r}`), Mr = i(/[^\]]/, p), Er = l([y, Cr, br, Mr]), B = x([$r, tr(Ar), f2(Er), wr]), Pr = i("{", "(?:"), Or = i("}", ")"), Rr = i(/(\d+)\.\.(\d+)/, (r, e, n) => or(+e, +n, Math.min(e.length, n.length)).join("|")), zr = i(/([a-z]+)\.\.([a-z]+)/, (r, e, n) => R(e, n).join("|")), jr = i(/([A-Z]+)\.\.([A-Z]+)/, (r, e, n) => R(e.toLowerCase(), n.toLowerCase()).join("|").toUpperCase()), Nr = l([Rr, zr, jr]), I = x([Pr, Nr, Or]), kr = i("{", "(?:"), Br = i("}", ")"), Ir = i(",", "|"), Fr = i(/[$.*+?^(){[\]\|]/, (r) => `\\${r}`), Lr = i(/[^}]/, p), Zr = E(() => F), Dr = l([j, N, k, B, I, Zr, y, Fr, Ir, Lr]), F = x([kr, f2(Dr), Br]), Ur = f2(l([sr, cr, lr, fr, j, N, k, B, I, F, y, pr, vr])), Vr = Ur, Gr = z(Vr), L = Gr, Tr = i(/\\./, p), qr = i(/./, p), Hr = i(/\*\*\*+/, "*"), Jr = i(/([^/{[(!])\*\*/, (r, e) => `${e}*`), Qr = i(/(^|.)\*\*(?=[^*/)\]}])/, (r, e) => `${e}*`), Wr = f2(l([Tr, Hr, Jr, Qr, qr])), Kr = Wr, Xr = z(Kr), Yr = Xr, $ = (r, e) => {
...
var resolve2 = function(...arguments_) {
  ...
  let resolvedAbsolute = false;
  for (let index3 = arguments_.length - 1; index3 >= -1 && !resolvedAbsolute; index3--) {
    const path = index3 >= 0 ? arguments_[index3] : cwd2();
    if (!path || path.length === 0) {
      continue;
    }
    resolvedPath = `${path}/${resolvedPath}`;
...
var toNamespacedPath = function(p) {
  return normalizeWindowsPath2(p);
};
...
var basename = function(p, extension) {
  const segments = normalizeWindowsPath2(p).split("/");
  let lastSegment = "";
...
var delimiter = (() => globalThis.process?.platform === "win32" ? ";" : ":")();
...
function getUsedProps(fn2) {
  let fnString = filterOutComments(fn2.toString());
...
function beforeAll(fn2, timeout = getDefaultHookTimeout()) {
  ...
  return getCurrentSuite().on("beforeAll", Object.assign(withTimeout(fn2, timeout, true, stackTraceError), {
...
function afterAll(fn2, timeout) {
  ...
  return getCurrentSuite().on("afterAll", withTimeout(fn2, timeout ?? getDefaultHookTimeout(), true, new Error("STACK_TRACE_ERROR")));
}
...
function parseSingleFFOrSafariStack2(raw) {
  ...
  const [url, lineNumber, columnNumber] = extractLocation2(locationPart);
  if (!url || !lineNumber || !columnNumber) {
    return null;
  }
  return {
...
async function saveInlineSnapshots(environment, snapshots) {
  const MagicString = (await import("./magic-string.es-XQO4KN2N.js")).default;
  ...
  await Promise.all(Array.from(files).map(async (file) => {
    ...
    for (const snap of snaps) {
      const index3 = positionToOffset(code, snap.line, snap.column);
      replaceInlineSnap(code, s, index3, snap.snapshot);
    }
...
function replaceObjectSnap(code, s, index3, newSnap) {
  let _code = code.slice(index3);
  ...
  callEnd += index3 + startMatch.index;
  const shapeStart = index3 + startMatch.index + startMatch[0].length;
  const shapeEnd = getObjectShapeEndIndex(code, shapeStart);
  const snap = `, ${prepareSnapString(newSnap, code, index3)}`;
  if (shapeEnd === callEnd) {
...
function getObjectShapeEndIndex(code, index3) {
  let startBraces = 1;
  let endBraces = 0;
  while (startBraces !== endBraces && index3 < code.length) {
    const s = code[index3++];
    if (s === "{") {
      startBraces++;
    } else if (s === "}") {
...
function prepareSnapString(snap, source, index3) {
  const lineNumber = offsetToLineNumber(source, index3);
...
function getCodeStartingAtIndex(code, index3) {
  const indexInline = index3 - toMatchInlineName.length;
  if (code.slice(indexInline, index3) === toMatchInlineName) {
    return {
      code: code.slice(indexInline),
      index: indexInline
    };
  }
  const indexThrowInline = index3 - toThrowErrorMatchingInlineName.length;
  if (code.slice(index3 - indexThrowInline, index3) === toThrowErrorMatchingInlineName) {
    return {
      code: code.slice(index3 - indexThrowInline),
      index: index3 - indexThrowInline
    };
  }
  return {
    code: code.slice(index3),
    index: index3
  };
}
...
function replaceInlineSnap(code, s, currentIndex, newSnap) {
  const { code: codeStartingAtIndex, index: index3 } = getCodeStartingAtIndex(code, currentIndex);
  ...
  if (!startMatch || startMatch.index !== (firstKeywordMatch === null || firstKeywordMatch === void 0 ? void 0 : firstKeywordMatch.index)) {
    return replaceObjectSnap(code, s, index3, newSnap);
  }
  const quote = startMatch[1];
  const startIndex = index3 + startMatch.index + startMatch[0].length;
  const snapString = prepareSnapString(newSnap, code, index3);
  if (quote === ")") {
...
var naturalCompare = getDefaultExportFromCjs3(naturalCompareExports);
...
function deepMergeArray(target = [], source = []) {
  ...
  source.forEach((sourceElement, index3) => {
    const targetElement = mergedOutput[index3];
    if (Array.isArray(target[index3])) {
      mergedOutput[index3] = deepMergeArray(target[index3], sourceElement);
    } else if (isObject2(targetElement)) {
      mergedOutput[index3] = deepMergeSnapshot(target[index3], sourceElement);
    } else {
      mergedOutput[index3] = sourceElement;
    }
  });
  return mergedOutput;
}
...
function throwWithCause(error, source) {
  if (error.cause == null) error.cause = new Error("Matcher did not succeed in time.");
      ...
      return function(...args) {
          ...
          try {
            while (true) {
              ...
              try {
                ...
                if (isLastAttempt || executionPhase === "assertion" && chai_exports.util.flag(assertion, "_poll.assert_once")) throwWithCause(err, STACK_TRACE_ERROR);
        ...
        test5.onFinished.push(() => {
          if (!awaited) {
            ...
            throw copyStackTrace$1(new Error(`${assertionString} was not awaited. This assertion is asynchronous and must be awaited; otherwise, it is not executed to avoid unhandled rejections:
...
function recordAsyncExpect2(_test2, promise, assertion, error) {
  ...
  if (test5 && promise instanceof Promise) {
    promise = promise.finally(() => {
      ...
      const index3 = test5.promises.indexOf(promise);
      if (index3 !== -1) test5.promises.splice(index3, 1);
    });
...
var SnapshotPlugin = (chai, utils) => {
  ...
  utils.addMethod(chai.Assertion.prototype, "toMatchFileSnapshot", function(file, message) {
    ...
    const errorMessage = utils.flag(this, "message");
    return recordAsyncExpect2(test5, getSnapshotClient().assertRaw({
      received: expected,
      message,
      isInline: false,
      rawSnapshot: { file },
      errorMessage,
      ...getTestNames(test5)
    }), createAssertionMessage2(utils, this), error);
  });
...
function requireCalledInOrder() {
  ...
  function checkAdjacentCalls(callMap, spy, index3, spies) {
    var calledBeforeNext = true;
    if (index3 !== spies.length - 1) {
      calledBeforeNext = spy.calledBefore(spies[index3 + 1]);
    }
      ...
      for (i = 0, l = clock.methods.length; i < l; i++) {
        ...
        if (clock.timersPromisesModuleMethods !== void 0) {
          if (nameOfMethodToReplace === "setTimeout") {
            ...
            timersPromisesModule.setTimeout = (delay2, value, options = {}) => new Promise((resolve4, reject) => {
              const abort = () => {
...
function normalizeWindowsPath3(input = "") {
  return input && input.replace(/\\/g, "/").replace(_DRIVE_LETTER_START_RE3, (r) => r.toUpperCase());
}
...
var resolve3 = function(...arguments_) {
  ...
  for (let index3 = arguments_.length - 1; index3 >= -1 && !resolvedAbsolute; index3--) {
    let path = index3 >= 0 ? arguments_[index3] : cwd3();
    !path || path.length === 0 || (resolvedPath = `${path}/${resolvedPath}`, resolvedAbsolute = isAbsolute3(path));
  }
...
function normalizeString3(path, allowAboveRoot) {
  let res = "", lastSegmentLength = 0, lastSlash = -1, dots = 0, char = null;
  for (let index3 = 0; index3 <= path.length; ++index3) {
    if (index3 < path.length) char = path[index3];
    else if (char === "/") break;
    else char = "/";
    if (char === "/") {
      if (!(lastSlash === index3 - 1 || dots === 1)) if (dots === 2) {
        if (res.length < 2 || lastSegmentLength !== 2 || res[res.length - 1] !== "." || res[res.length - 2] !== ".") {
          if (res.length > 2) {
            let lastSlashIndex = res.lastIndexOf("/");
            lastSlashIndex === -1 ? (res = "", lastSegmentLength = 0) : (res = res.slice(0, lastSlashIndex), lastSegmentLength = res.length - 1 - res.lastIndexOf("/")), lastSlash = index3, dots = 0;
            continue;
          } else if (res.length > 0) {
            res = "", lastSegmentLength = 0, lastSlash = index3, dots = 0;
            continue;
          }
        }
        allowAboveRoot && (res += res.length > 0 ? "/.." : "..", lastSegmentLength = 2);
      } else res.length > 0 ? res += `/${path.slice(lastSlash + 1, index3)}` : res = path.slice(lastSlash + 1, index3), lastSegmentLength = index3 - lastSlash - 1;
      lastSlash = index3, dots = 0;
...
var dirname2 = function(p) {
  let segments = normalizeWindowsPath3(p).replace(/\/$/, "").split("/").slice(0, -1);
  return segments.length === 1 && _DRIVE_LETTER_RE2.test(segments[0]) && (segments[0] += "/"), segments.join("/") || (isAbsolute3(p) ? "/" : ".");
};
...
for (let i = 0; i < chars3.length; i++) {
  let c = chars3.charCodeAt(i);
  intToChar3[i] = c, charToInt3[c] = i;
}
var DecodedMap2 = class {
  _encoded;
  _decoded;
  _decodedMemo;
  url;
  ...
  constructor(map2, from) {
    ...
    this.version = map2.version, this.names = names || [], this._encoded = mappings || "", this._decodedMemo = memoizedState2(), this.url = from, this.file = from;
...
var EvaluatedModules = class {
  ...
  getModuleSourceMapById(id) {
    ...
    return mapString ? (mod.map = new DecodedMap2(JSON.parse(decodeBase64(mapString)), mod.file), mod.map) : null;
  }
  clear() {
...
var VitestEvaluatedModules = class extends EvaluatedModules {
  getModuleSourceMapById(id) {
    const map2 = super.getModuleSourceMapById(id);
    if (map2 != null && !("_patched" in map2)) {
      map2._patched = true;
      const dir = dirname(map2.url);
      map2.resolvedSources = (map2.map.sources || []).map((s) => resolve2(dir, s || ""));
    }
    return map2;
  }
};
...
var index2 = Object.freeze({
  ...
  describe,
  expect: globalExpect,
  expectTypeOf: import_expect_type.expectTypeOf,
  inject,
  it,
  onTestFailed,
  onTestFinished,
...
var import_expect_type2 = __toESM(require_dist());
var export_expectTypeOf = import_expect_type2.expectTypeOf;
export {
  VitestEvaluatedModules as EvaluatedModules,
  afterAll,
  afterEach,
  assert4 as assert,
  assertType,
  ...
  export_expectTypeOf as expectTypeOf,
  inject,
  it,
  onTestFailed,
  onTestFinished,
